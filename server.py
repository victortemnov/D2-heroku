...
<html lang="en">
    ...
    <body>
        ...
        <hr>
        <h2>For visit <b>successful</b> page, append to the end of URL "https://heroku-d2-hw.herokuapp.com<span>/success</span>"</h2>
        <hr>
        <h2>For visit <b>fail</b> page, append to the end of URL "https://heroku-d2-hw.herokuapp.com<span>/fail</span>"</h2>
        <hr>
    </body>
</html>
"""
